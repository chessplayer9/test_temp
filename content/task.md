  ...
  - block: markdown
    content:
      text: |
        ...
        <style>.inline-code {font-family: monospace;background-color: #f0f0f0;padding: 0.2em 0.4em;border-radius: 3px;}</style><p>在Python中，<div class="inline-code">print("Hello")</div>会输出文本到控制台。</p>
