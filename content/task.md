  ...
  - block: markdown
    content:
      text: |
        ...
        - **ID Classes**: We use the 94 classes across different coarse-classes as in-distribution (ID) classes, defined in <div>{{ "this`./sub-dataset1-RGB-domain1/OOD_split/ID_94.txt`" | markdownify }}</div>.
