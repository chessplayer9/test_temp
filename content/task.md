  ...
  - block: markdown
    content:
      text: |
        ...
        <ul style="list-style-type: disc;"> <!-- 实心圆（默认） --><li>自定义实心圆点</li></ul>**Resampling bias**, requiring model generalization across varying acquisition parameters (angle, height, resolution, time) within the same modality; 
