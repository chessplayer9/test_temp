  ...
  - block: markdown
    content:
      text: |
        ...
        <style>.inline-code {font-family: monospace;background-color: #f0f0f0;padding: 0.2em 0.4em;border-radius: 3px;color: #c7254e;}</style><p>在Python中，<code class="inline-code">print("Hello")</code>会输出文本到控制台。</p>
